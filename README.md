...
Note that the gravatar requires the email property. You also need to check the compatibility of the chosen theme. Currently, only the default theme, material theme, 8bits theme and so forth supports Gravatar.
